...
infercnvObj <- CreateInfercnvObject(raw_counts_matrix = counts_mat,
...
infercnvObj <- CreateInfercnvObject(raw_counts_matrix = counts_tnbc1,
                                    annotations_file = sample_annot,
                                    gene_order_file = gene_order,
